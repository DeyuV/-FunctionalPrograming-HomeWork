package org.endava.tmd.FunctionalPrograming;
...
public class CrazyLambdas {
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return n -> boundedRandomIntSupplier().applyAsInt(new Random().nextInt(n));
    }
    ...
    public static IntUnaryOperator intSquareOperation() {
        return n -> boundedRandomIntSupplier().applyAsInt(n * n);
    }
    ...
    public static LongBinaryOperator longSumOperation() {
        return (long l1, long l2) -> longSumOperation().applyAsLong(l1+l1, l2+l2);
    }
    ...
    public static ToIntFunction<String> stringToIntConverter() {
        return s -> stringToIntConverter().applyAsInt(s);
    }
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        return t -> newThreadRunnableConsumer().accept(t);
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (u, p) -> (t -> p.test(t) ? u.applyAsInt(t) : t);
    }
